...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('teacher_yet', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now=True)),
                ('updated', models.DateField(auto_now=True)),
                ('destination', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.Destination')),
                ('teacher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.teacher')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='location',
            name='teacher',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.teacher'),
        ),
        migrations.AddField(
            model_name='location',
            name='sport',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.Sport'),
        ),
        migrations.AddField(
            model_name='destination',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teach.Location'),
        ),
        migrations.AddField(
            model_name='destination',
            name='teacher',
