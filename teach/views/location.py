...
def publish_location(request):
    if request.method == "GET":
        ...
        if not user.is_authenticated:
            ...
            return render(request, "teach/location/create_location.html", {"user":user} )
...
def create_location(request):
    if request.method == "POST":
        ...
        if not sport:
            return render(request, "teach/location/create_location.html", {"error":"Please choose a sport!"})
        ...
        if address == "" or len(zip) < 5:
            return render(request, "teach/location/create_location.html", {"error":"Enter a proper address"})
        ...
        try:
            ...
            return render(request, "teach/location/show_sport.html", {"user":user, "location":location})
        except:
            return render(request, "teach/location/create_location.html", {"error":"Can't create the location"})
    else:
        user = request.user
